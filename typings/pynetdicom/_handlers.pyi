...
def debug_data(event: Event, pdu_type: int | None = ..., print_raw: bool = ..., print_summary: bool = ...) -> None:
...
def standard_pdu_recv_handler(event: Event) -> list[str]:
    """Define a standard handler when a PDU is received and decoded.
...
def standard_pdu_sent_handler(event: Event) -> list[str]:
    """Define a standard handler when a PDU is encoded and sent.
...
def standard_dimse_recv_handler(event: Event) -> list[str]:
    """Define a standard handler for the ACSE receiving a primitive from the DUL.
...
def doc_handle_move(event: Event, *args: Sequence[Any]) -> CMoveType:
    ...
    allows you to customize the presentation contexts requested by the
    ...
    **Status**
    ...
    Failure
      ...
      | `0xC104` - IDs inconsistent in matching a current study; Event not
        logged
      | `0xC10E` - Operator not authorized to add entry to Medication
    ...
    Warning
      | `0xB101` - Specified Synchronization Frame of Reference UID does not
        match SOP Synchronization Frame of Reference
...
def doc_handle_set(event: Event, *args: Sequence[Any]) -> UserReturnType:
    ...
    **Status**
    ...
    Failure
      ...
      | `0x0106` - Invalid attribute value
      | `0x0110` - Processing failure
      | `0x0112` - SOP Instance not recognized
      | `0x0116` - Attribute value out of range
      | `0x0117` - Invalid object instance
      | `0x0118` - No such SOP Class
      | `0x0119` - Class-Instance conflict
...
def doc_handle_sop_common(event: Event, *args: Sequence[Any]) -> dict[UID, SOPClassCommonExtendedNegotiation]:
...
def doc_handle_userid(event: Event, *args: Sequence[Any]) -> tuple[bool, bytes | None]:
